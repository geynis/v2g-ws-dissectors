-- File : v2gsdp.lua
-- Who  : Amit Geynis
-- What : V2G SDP dissector

-- V2G SDP

p_sdpreq = Proto("v2gsdp-req","Vehicle-to-Grid SECC Discovery Protocol - Request")
p_sdpres = Proto("v2gsdp-res","Vehicle-to-Grid SECC Discovery Protocol - Response")
